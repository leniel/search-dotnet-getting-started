...
namespace AzureSearch.SDKHowTo
{
    ...
    class Program
    {
        ...
        private static void CreateIndex(string indexName, SearchServiceClient serviceClient)
        {
            ...
            {
                Name = indexName,
                Fields = FieldBuilder.BuildForType<Institution>()
            };
        ...
        private static void UploadDocuments(ISearchIndexClient indexClient)
        {
            ...
            var batch = IndexBatch.Upload(institutions);
        ...
        private static void RunQueries(ISearchIndexClient indexClient)
        {
            ...
            DocumentSearchResult<Institution> results;

            Console.WriteLine("Search the entire index for the term '1&1' and return only the Name field:\n");
            ...
            results = indexClient.Documents.Search<Institution>("1&1", parameters);

            WriteDocuments(results);

            //Console.Write("Apply a filter to the index to find Institutions with a room cheaper than $100 per night, ");
        ...
        private static void WriteDocuments(DocumentSearchResult<Institution> searchResults)
        {
            foreach (SearchResult<Institution> institution in searchResults.Results)
            {
                Console.WriteLine(institution.Document);
            }
